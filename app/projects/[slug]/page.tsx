            ...
            <div className="lg:w-[40%] lg:pt-2">
              ...
              {isFounderPage && currentFounder ? (
                <div key={currentFounder.founderName}>
                  <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold mb-2 leading-tight whitespace-nowrap">
                    {currentFounder.founderName}
                  </h1>
                  <p className="text-2xl md:text-3xl font-bold mb-4 opacity-70">
                  ...
                  <div className="flex items-center gap-3 mb-6">
                    <a
                      ...
                      aria-label={`${currentFounder.founderName} ${currentFounder.founderUrlType}`}
                    >
                    ...
                    <a
                      ...
                      rel="noopener noreferrer"
                      className="opacity-50 hover:opacity-90 transition-opacity"
                      aria-label={`${currentFounder.company} ${currentFounder.companyUrlType}`}
                    >
